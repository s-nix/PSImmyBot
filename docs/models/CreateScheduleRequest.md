...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[CreateScheduleRequest](CreateScheduleRequest.md)> |
| Source | `Models/CreateScheduleRequest.cs` |

## Overview
`CreateScheduleRequest` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/CreateScheduleRequest.cs`
