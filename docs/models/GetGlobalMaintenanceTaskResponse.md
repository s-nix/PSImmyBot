---
title: GetGlobalMaintenanceTaskResponse
---

# GetGlobalMaintenanceTaskResponse
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[GetGlobalMaintenanceTaskResponse](GetGlobalMaintenanceTaskResponse.md)> |
| Source | `Models/GetGlobalMaintenanceTaskResponse.cs` |

## Overview
`GetGlobalMaintenanceTaskResponse` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/GetGlobalMaintenanceTaskResponse.cs`
