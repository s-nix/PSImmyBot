---
title: UpdateLocalMaintenanceTaskPayload
---

# UpdateLocalMaintenanceTaskPayload
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[UpdateLocalMaintenanceTaskPayload](UpdateLocalMaintenanceTaskPayload.md)> |
| Source | `Models/UpdateLocalMaintenanceTaskPayload.cs` |

## Overview
`UpdateLocalMaintenanceTaskPayload` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
| Tenants | ICollection<[LocalMaintenanceTaskTenantPayload](LocalMaintenanceTaskTenantPayload.md)> | Reference type (nullable) | — |
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/UpdateLocalMaintenanceTaskPayload.cs`
