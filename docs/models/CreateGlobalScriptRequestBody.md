---
title: CreateGlobalScriptRequestBody
---

# CreateGlobalScriptRequestBody
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[CreateGlobalScriptRequestBody](CreateGlobalScriptRequestBody.md)> |
| Source | `Models/CreateGlobalScriptRequestBody.cs` |

## Overview
`CreateGlobalScriptRequestBody` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/CreateGlobalScriptRequestBody.cs`
