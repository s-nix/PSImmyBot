...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[LocalSoftware](LocalSoftware.md)> |
| Source | `Models/LocalSoftware.cs` |

## Overview
`LocalSoftware` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
| SoftwareVersions | ICollection<[LocalSoftwareVersion](LocalSoftwareVersion.md)> | Reference type (nullable) | — |
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/LocalSoftware.cs`
