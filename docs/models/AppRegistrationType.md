...
| Source | `Models/AppRegistrationType.cs` |

## Overview
`AppRegistrationType` is a Enum from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/AppRegistrationType.cs`
