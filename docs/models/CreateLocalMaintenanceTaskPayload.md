---
title: CreateLocalMaintenanceTaskPayload
---

# CreateLocalMaintenanceTaskPayload
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[CreateLocalMaintenanceTaskPayload](CreateLocalMaintenanceTaskPayload.md)> |
| Source | `Models/CreateLocalMaintenanceTaskPayload.cs` |

## Overview
`CreateLocalMaintenanceTaskPayload` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/CreateLocalMaintenanceTaskPayload.cs`
