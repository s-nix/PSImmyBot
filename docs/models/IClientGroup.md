...
## Overview
`IClientGroup` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.

## Structure

| Property | Type | Nullable | Notes |
| --- | --- | --- | --- |
| ClientGroupDisplayName | `string` | Reference type (nullable) | — |
| ClientGroupId | `string` | Reference type (nullable) | — |

## Serialization

- Namespace: `PSImmyBot.Models`
- Source file: `Models/IClientGroup.cs`
