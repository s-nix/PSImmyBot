---
title: CreateLocalSoftwareVersionRequestBody
---
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[CreateLocalSoftwareVersionRequestBody](CreateLocalSoftwareVersionRequestBody.md)> |
| Source | `Models/CreateLocalSoftwareVersionRequestBody.cs` |

## Overview
`CreateLocalSoftwareVersionRequestBody` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/CreateLocalSoftwareVersionRequestBody.cs`
