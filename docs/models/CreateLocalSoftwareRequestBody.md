---
title: CreateLocalSoftwareRequestBody
---

# CreateLocalSoftwareRequestBody
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[CreateLocalSoftwareRequestBody](CreateLocalSoftwareRequestBody.md)> |
| Source | `Models/CreateLocalSoftwareRequestBody.cs` |

## Overview
`CreateLocalSoftwareRequestBody` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/CreateLocalSoftwareRequestBody.cs`
