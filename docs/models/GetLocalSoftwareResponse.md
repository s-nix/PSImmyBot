...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | `IEquatable<GetLocalSoftwareResponse>` |
...
| SoftwareIcon | `LocalMediaResponse` | Reference type (nullable) | — |
...
| SoftwareVersions | `ICollection<GetLocalSoftwareVersionResponse>` | Reference type (nullable) | — |
