---
title: GetLocalSoftwareVersionResponse
---

# GetLocalSoftwareVersionResponse
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[GetLocalSoftwareVersionResponse](GetLocalSoftwareVersionResponse.md)> |
| Source | `Models/GetLocalSoftwareVersionResponse.cs` |

## Overview
`GetLocalSoftwareVersionResponse` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
| Software | [GetLocalSoftwareResponse](GetLocalSoftwareResponse.md) | Reference type (nullable) | — |
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/GetLocalSoftwareVersionResponse.cs`
