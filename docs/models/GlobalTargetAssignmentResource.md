---
title: GlobalTargetAssignmentResource
---

# GlobalTargetAssignmentResource
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[GlobalTargetAssignmentResource](GlobalTargetAssignmentResource.md)> |
| Source | `Models/GlobalTargetAssignmentResource.cs` |

## Overview
`GlobalTargetAssignmentResource` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/GlobalTargetAssignmentResource.cs`
