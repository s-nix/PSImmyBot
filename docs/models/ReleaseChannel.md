...
| Source | `Models/ReleaseChannel.cs` |

## Overview
`ReleaseChannel` is a Enum from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/ReleaseChannel.cs`
