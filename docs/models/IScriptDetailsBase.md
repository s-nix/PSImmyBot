...
## Overview
`IScriptDetailsBase` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/IScriptDetailsBase.cs`
