...
| Source | `Models/SecurityRuleSet.cs` |

## Overview
`SecurityRuleSet` is a Enum from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/SecurityRuleSet.cs`
