---
title: AnalyzeGlobalSoftwarePackageResponse
---

# AnalyzeGlobalSoftwarePackageResponse
...
| Assembly | `PSImmyBot` |
| Base Type | `object` |
| Implements | IEquatable<[AnalyzeGlobalSoftwarePackageResponse](AnalyzeGlobalSoftwarePackageResponse.md)> |
| Source | `Models/AnalyzeGlobalSoftwarePackageResponse.cs` |

## Overview
`AnalyzeGlobalSoftwarePackageResponse` is a Class from `PSImmyBot.Models` and participates in ImmyBot API payloads generated by the module.
...
- Namespace: `PSImmyBot.Models`
- Source file: `Models/AnalyzeGlobalSoftwarePackageResponse.cs`
