---
title: New-ImmyCreateBrandingRequestBody
---

# New-ImmyCreateBrandingRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewCreateBrandingRequestBody` |
| Source | `Cmdlets/NewCreateBrandingRequestBody.cs` |
| HTTP Method | Custom |
