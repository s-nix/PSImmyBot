---
title: New-ImmyUpdateLicenseRequestBody
---

# New-ImmyUpdateLicenseRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateLicenseRequestBody` |
| Source | `Cmdlets/NewUpdateLicenseRequestBody.cs` |
| HTTP Method | Custom |
