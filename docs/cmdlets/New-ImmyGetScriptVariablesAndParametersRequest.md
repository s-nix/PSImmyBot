---
title: New-ImmyGetScriptVariablesAndParametersRequest
---

# New-ImmyGetScriptVariablesAndParametersRequest

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetScriptVariablesAndParametersRequest` |
| Source | `Cmdlets/NewGetScriptVariablesAndParametersRequest.cs` |
| HTTP Method | Custom |
