...
| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewMethodInfo` |
| Source | `Cmdlets/NewMethodInfo.cs` |
| HTTP Method | Custom |
...
| ReturnParameter | [ParameterInfo](../models/ParameterInfo.md) | True | — | All | None |
| ReturnType | [Type](../models/Type.md) | True | — | All | None |
| ReturnTypeCustomAttributes | [ICustomAttributeProvider](../models/ICustomAttributeProvider.md) | True | — | All | None |
