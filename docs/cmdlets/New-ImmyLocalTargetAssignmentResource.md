---
title: New-ImmyLocalTargetAssignmentResource
---

# New-ImmyLocalTargetAssignmentResource

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewLocalTargetAssignmentResource` |
| Source | `Cmdlets/NewLocalTargetAssignmentResource.cs` |
| HTTP Method | Custom |
...
| Visibility | [TargetAssignmentVisibilityResource](../models/TargetAssignmentVisibilityResource.md) | True | — | All | None |
