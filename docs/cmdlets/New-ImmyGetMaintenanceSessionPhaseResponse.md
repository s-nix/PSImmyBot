---
title: New-ImmyGetMaintenanceSessionPhaseResponse
---

# New-ImmyGetMaintenanceSessionPhaseResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetMaintenanceSessionPhaseResponse` |
| Source | `Cmdlets/NewGetMaintenanceSessionPhaseResponse.cs` |
| HTTP Method | Custom |
