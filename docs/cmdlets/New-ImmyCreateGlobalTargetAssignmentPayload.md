---
title: New-ImmyCreateGlobalTargetAssignmentPayload
---

# New-ImmyCreateGlobalTargetAssignmentPayload

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewCreateGlobalTargetAssignmentPayload` |
| Source | `Cmdlets/NewCreateGlobalTargetAssignmentPayload.cs` |
| HTTP Method | Custom |
