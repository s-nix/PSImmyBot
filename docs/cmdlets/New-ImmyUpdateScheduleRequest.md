---
title: New-ImmyUpdateScheduleRequest
---

# New-ImmyUpdateScheduleRequest

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateScheduleRequest` |
| Source | `Cmdlets/NewUpdateScheduleRequest.cs` |
| HTTP Method | Custom |
