---
title: New-ImmyGlobalSoftwareVersion
---

# New-ImmyGlobalSoftwareVersion

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGlobalSoftwareVersion` |
| Source | `Cmdlets/NewGlobalSoftwareVersion.cs` |
| HTTP Method | Custom |
...
| Software | [GlobalSoftware](../models/GlobalSoftware.md) | True | — | All | None |
