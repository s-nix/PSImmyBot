---
title: Get-ImmyChangeRequestByDeployment
---

# Get-ImmyChangeRequestByDeployment

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.GetChangeRequestByDeployment` |
| Source | `Cmdlets/GetChangeRequestByDeployment.cs` |
| HTTP Method | GET |
