...
| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.GetRmmLink` |
| Source | `Cmdlets/GetRmmLink.cs` |
| HTTP Method | GET |
...
## Behavior
- Calls `ImmyBotApiService.GET` targeting `/api/v1/rmm-links/{Id}?` and deserializes to [GetProviderLinkResponse](../models/GetProviderLinkResponse.md).
