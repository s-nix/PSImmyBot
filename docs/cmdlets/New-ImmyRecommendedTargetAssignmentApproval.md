---
title: New-ImmyRecommendedTargetAssignmentApproval
---

# New-ImmyRecommendedTargetAssignmentApproval

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewRecommendedTargetAssignmentApproval` |
| Source | `Cmdlets/NewRecommendedTargetAssignmentApproval.cs` |
| HTTP Method | Custom |
