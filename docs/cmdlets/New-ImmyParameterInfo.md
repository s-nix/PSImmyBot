---
title: New-ImmyParameterInfo
---

# New-ImmyParameterInfo

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewParameterInfo` |
| Source | `Cmdlets/NewParameterInfo.cs` |
| HTTP Method | Custom |
...
| IsIn | `Boolean` | True | — | All | None |
| IsLcid | `Boolean` | True | — | All | None |
