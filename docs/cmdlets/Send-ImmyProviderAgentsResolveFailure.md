---
title: Send-ImmyProviderAgentsResolveFailure
---

# Send-ImmyProviderAgentsResolveFailure

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.SendProviderAgentsResolveFailure` |
| Source | `Cmdlets/SendProviderAgentsResolveFailure.cs` |
| HTTP Method | POST |
