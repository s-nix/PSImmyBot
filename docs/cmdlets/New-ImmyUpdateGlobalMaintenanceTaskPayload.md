---
title: New-ImmyUpdateGlobalMaintenanceTaskPayload
---

# New-ImmyUpdateGlobalMaintenanceTaskPayload

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateGlobalMaintenanceTaskPayload` |
| Source | `Cmdlets/NewUpdateGlobalMaintenanceTaskPayload.cs` |
| HTTP Method | Custom |
