---
title: Send-ToggleApplicationLogStreamingRequest
---

# Send-ToggleApplicationLogStreamingRequest
...
| --- | --- | --- | --- | --- | --- |
| PayloadBody | `ToggleApplicationLogStreamingRequest` | True | — | All | None |
