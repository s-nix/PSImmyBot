---
title: New-ImmyGetPreferencesResponse
---

# New-ImmyGetPreferencesResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetPreferencesResponse` |
| Source | `Cmdlets/NewGetPreferencesResponse.cs` |
| HTTP Method | Custom |
