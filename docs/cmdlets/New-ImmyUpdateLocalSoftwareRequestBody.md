---
title: New-ImmyUpdateLocalSoftwareRequestBody
---

# New-ImmyUpdateLocalSoftwareRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateLocalSoftwareRequestBody` |
| Source | `Cmdlets/NewUpdateLocalSoftwareRequestBody.cs` |
| HTTP Method | Custom |
