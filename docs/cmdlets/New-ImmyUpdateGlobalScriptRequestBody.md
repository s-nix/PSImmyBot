---
title: New-ImmyUpdateGlobalScriptRequestBody
---

# New-ImmyUpdateGlobalScriptRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateGlobalScriptRequestBody` |
| Source | `Cmdlets/NewUpdateGlobalScriptRequestBody.cs` |
| HTTP Method | Custom |
