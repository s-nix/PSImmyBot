---
title: New-ImmyUpdateLocalMediaPayload
---

# New-ImmyUpdateLocalMediaPayload

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateLocalMediaPayload` |
| Source | `Cmdlets/NewUpdateLocalMediaPayload.cs` |
| HTTP Method | Custom |
