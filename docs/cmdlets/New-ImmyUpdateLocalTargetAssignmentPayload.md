---
title: New-ImmyUpdateLocalTargetAssignmentPayload
---

# New-ImmyUpdateLocalTargetAssignmentPayload

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateLocalTargetAssignmentPayload` |
| Source | `Cmdlets/NewUpdateLocalTargetAssignmentPayload.cs` |
| HTTP Method | Custom |
...
| Visibility | [TargetAssignmentVisibilityPayload](../models/TargetAssignmentVisibilityPayload.md) | True | — | All | None |
