---
title: New-ImmyComputerUserAffinityResponse
---

# New-ImmyComputerUserAffinityResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewComputerUserAffinityResponse` |
| Source | `Cmdlets/NewComputerUserAffinityResponse.cs` |
| HTTP Method | Custom |
