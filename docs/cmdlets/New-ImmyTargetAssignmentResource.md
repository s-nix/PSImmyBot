---
title: New-ImmyTargetAssignmentResource
---

# New-ImmyTargetAssignmentResource

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewTargetAssignmentResource` |
| Source | `Cmdlets/NewTargetAssignmentResource.cs` |
| HTTP Method | Custom |
