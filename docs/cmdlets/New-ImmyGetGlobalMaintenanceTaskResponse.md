---
title: New-ImmyGetGlobalMaintenanceTaskResponse
---

# New-ImmyGetGlobalMaintenanceTaskResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetGlobalMaintenanceTaskResponse` |
| Source | `Cmdlets/NewGetGlobalMaintenanceTaskResponse.cs` |
| HTTP Method | Custom |
...
| Icon | [MediaResponseBase](../models/MediaResponseBase.md) | True | — | All | None |
