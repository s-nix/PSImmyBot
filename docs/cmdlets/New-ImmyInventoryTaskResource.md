---
title: New-ImmyInventoryTaskResource
---

# New-ImmyInventoryTaskResource

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewInventoryTaskResource` |
| Source | `Cmdlets/NewInventoryTaskResource.cs` |
| HTTP Method | Custom |
