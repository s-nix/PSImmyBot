---
title: Get-ImmyAzureErrorLogItems
---

# Get-ImmyAzureErrorLogItems
...
## Behavior
- Calls `ImmyBotApiService.GET` targeting `/api/v1/azure-errors/dx?` and deserializes to List<[AzureErrorLogItem](../models/AzureErrorLogItem.md)>.
