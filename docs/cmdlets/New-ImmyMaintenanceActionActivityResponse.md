---
title: New-ImmyMaintenanceActionActivityResponse
---

# New-ImmyMaintenanceActionActivityResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewMaintenanceActionActivityResponse` |
| Source | `Cmdlets/NewMaintenanceActionActivityResponse.cs` |
| HTTP Method | Custom |
