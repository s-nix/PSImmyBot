---
title: New-ImmyCreateScheduleRequest
---

# New-ImmyCreateScheduleRequest

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewCreateScheduleRequest` |
| Source | `Cmdlets/NewCreateScheduleRequest.cs` |
| HTTP Method | Custom |
