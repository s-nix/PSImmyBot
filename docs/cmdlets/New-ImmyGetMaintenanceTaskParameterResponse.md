---
title: New-ImmyGetMaintenanceTaskParameterResponse
---

# New-ImmyGetMaintenanceTaskParameterResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetMaintenanceTaskParameterResponse` |
| Source | `Cmdlets/NewGetMaintenanceTaskParameterResponse.cs` |
| HTTP Method | Custom |
