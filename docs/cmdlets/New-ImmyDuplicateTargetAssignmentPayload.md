---
title: New-ImmyDuplicateTargetAssignmentPayload
---

# New-ImmyDuplicateTargetAssignmentPayload

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewDuplicateTargetAssignmentPayload` |
| Source | `Cmdlets/NewDuplicateTargetAssignmentPayload.cs` |
| HTTP Method | Custom |
