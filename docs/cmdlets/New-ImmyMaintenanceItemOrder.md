---
title: New-ImmyMaintenanceItemOrder
---

# New-ImmyMaintenanceItemOrder

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewMaintenanceItemOrder` |
| Source | `Cmdlets/NewMaintenanceItemOrder.cs` |
| HTTP Method | Custom |
