---
title: New-ImmyCreateLocalScriptRequestBody
---

# New-ImmyCreateLocalScriptRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewCreateLocalScriptRequestBody` |
| Source | `Cmdlets/NewCreateLocalScriptRequestBody.cs` |
| HTTP Method | Custom |
