---
title: New-ImmyGetGlobalSoftwareVersionResponse
---

# New-ImmyGetGlobalSoftwareVersionResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetGlobalSoftwareVersionResponse` |
| Source | `Cmdlets/NewGetGlobalSoftwareVersionResponse.cs` |
| HTTP Method | Custom |
...
| Software | [GetGlobalSoftwareResponse](../models/GetGlobalSoftwareResponse.md) | True | — | All | None |
