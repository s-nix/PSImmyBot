---
title: New-ImmyGetSmtpConfigResponse
---

# New-ImmyGetSmtpConfigResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetSmtpConfigResponse` |
| Source | `Cmdlets/NewGetSmtpConfigResponse.cs` |
| HTTP Method | Custom |
