...
| --- | --- | --- | --- | --- | --- |
| ActionReason | `MaintenanceActionReason` | True | — | All | None |
| ActionResult | `MaintenanceActionResult` | True | — | All | None |
| ActionResultReason | `MaintenanceActionResultReason` | True | — | All | None |
| ActionResultReasonMessage | `String` | False | — | All | None |
| ActionStatus | `MaintenanceActionStatus` | True | — | All | None |
...
| DesiredVersion | `SemanticVersion` | True | — | All | None |
| DesiredVersionString | `String` | False | — | All | None |
| DetectedVersion | `SemanticVersion` | True | — | All | None |
...
| LastActionType | `ScriptLanguage` | True | — | All | None |
