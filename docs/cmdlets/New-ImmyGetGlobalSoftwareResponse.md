---
title: New-ImmyGetGlobalSoftwareResponse
---

# New-ImmyGetGlobalSoftwareResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetGlobalSoftwareResponse` |
| Source | `Cmdlets/NewGetGlobalSoftwareResponse.cs` |
| HTTP Method | Custom |
...
| SoftwareIcon | [GlobalMediaResponse](../models/GlobalMediaResponse.md) | True | — | All | None |
