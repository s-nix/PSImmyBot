---
title: New-ImmyGetLocalMaintenanceTaskResponse
---

# New-ImmyGetLocalMaintenanceTaskResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetLocalMaintenanceTaskResponse` |
| Source | `Cmdlets/NewGetLocalMaintenanceTaskResponse.cs` |
| HTTP Method | Custom |
