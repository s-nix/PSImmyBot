---
title: New-ImmyUpdateBrandingRequestBody
---

# New-ImmyUpdateBrandingRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateBrandingRequestBody` |
| Source | `Cmdlets/NewUpdateBrandingRequestBody.cs` |
| HTTP Method | Custom |
