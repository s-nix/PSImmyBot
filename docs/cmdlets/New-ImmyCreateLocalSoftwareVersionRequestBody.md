---
title: New-ImmyCreateLocalSoftwareVersionRequestBody
---

# New-ImmyCreateLocalSoftwareVersionRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewCreateLocalSoftwareVersionRequestBody` |
| Source | `Cmdlets/NewCreateLocalSoftwareVersionRequestBody.cs` |
| HTTP Method | Custom |
