---
title: New-ImmyGetGlobalScriptResponse
---

# New-ImmyGetGlobalScriptResponse

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewGetGlobalScriptResponse` |
| Source | `Cmdlets/NewGetGlobalScriptResponse.cs` |
| HTTP Method | Custom |
