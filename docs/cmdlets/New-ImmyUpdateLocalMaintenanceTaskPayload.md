---
title: New-ImmyUpdateLocalMaintenanceTaskPayload
---

# New-ImmyUpdateLocalMaintenanceTaskPayload

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUpdateLocalMaintenanceTaskPayload` |
| Source | `Cmdlets/NewUpdateLocalMaintenanceTaskPayload.cs` |
| HTTP Method | Custom |
