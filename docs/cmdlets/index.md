...
| Cmdlet | Purpose |
| --- | --- |
| [Connect-ImmyApi](Connect-Api.md) | Authenticates against Azure AD and caches the ImmyBot API token/configuration. |
| [Disconnect-ImmyApi](Disconnect-Api.md) | Clears cached connection info when you want to force a fresh login. |
| [Get-ImmyComputer](Get-Computer.md) | Fetches a specific computer record from ImmyBot. |
| [Get-ImmyComputersPaged](Get-ComputersPaged.md) | Streams paged computer data with optional filters. |
| [Get-ImmyAuth](Get-Auth.md) | Verifies the current authentication context using `/api/v1/auth`. |
