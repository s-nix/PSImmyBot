...
| Cmdlet | Purpose |
| --- | --- |
| [Connect-ImmyApi](Connect-ImmyApi.md) | Authenticates against Azure AD and caches the ImmyBot API token/configuration. |
| [Disconnect-ImmyApi](Disconnect-ImmyApi.md) | Clears cached connection info when you want to force a fresh login. |
| [Get-ImmyComputer](Get-ImmyComputer.md) | Fetches a specific computer record from ImmyBot. |
| [Get-ImmyComputersPaged](Get-ImmyComputersPaged.md) | Streams paged computer data with optional filters. |
| [Get-ImmyAuth](Get-ImmyAuth.md) | Verifies the current authentication context using `/api/v1/auth`. |
