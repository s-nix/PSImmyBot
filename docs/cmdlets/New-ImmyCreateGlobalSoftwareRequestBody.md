---
title: New-ImmyCreateGlobalSoftwareRequestBody
---

# New-ImmyCreateGlobalSoftwareRequestBody

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewCreateGlobalSoftwareRequestBody` |
| Source | `Cmdlets/NewCreateGlobalSoftwareRequestBody.cs` |
| HTTP Method | Custom |
