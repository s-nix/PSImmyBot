---
title: New-ImmyTenantMaintenanceTask
---

# New-ImmyTenantMaintenanceTask

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewTenantMaintenanceTask` |
| Source | `Cmdlets/NewTenantMaintenanceTask.cs` |
| HTTP Method | Custom |
