---
title: Get-ImmyProviderLinks
---

# Get-ImmyProviderLinks

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.GetProviderLinks` |
| Source | `Cmdlets/GetProviderLinks.cs` |
| HTTP Method | GET |
...
## Behavior
- Calls `ImmyBotApiService.GET` targeting `/api/v1/provider-links?` and deserializes to List<[GetProviderLinkResponse](../models/GetProviderLinkResponse.md)>.
