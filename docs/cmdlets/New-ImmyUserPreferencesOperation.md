---
title: New-ImmyUserPreferencesOperation
---

# New-ImmyUserPreferencesOperation

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewUserPreferencesOperation` |
| Source | `Cmdlets/NewUserPreferencesOperation.cs` |
| HTTP Method | Custom |
