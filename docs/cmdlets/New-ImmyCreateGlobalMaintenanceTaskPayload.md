---
title: New-ImmyCreateGlobalMaintenanceTaskPayload
---

# New-ImmyCreateGlobalMaintenanceTaskPayload

| Detail | Value |
| --- | --- |
| Class | `PSImmyBot.Cmdlets.NewCreateGlobalMaintenanceTaskPayload` |
| Source | `Cmdlets/NewCreateGlobalMaintenanceTaskPayload.cs` |
| HTTP Method | Custom |
