...
## Behavior
- Calls `ImmyBotApiService.POST` targeting `/api/v1/provider-links/{Id}/cross-references/{ExternalLinkId}/enable-client-linking?` and deserializes to `LinkedExternalLink`.
