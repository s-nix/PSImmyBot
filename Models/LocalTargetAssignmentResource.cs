...
public record LocalTargetAssignmentResource(
    ...
    [property: JsonPropertyName("isCore")] bool IsCore,
    [property: JsonPropertyName("licenseId")]
    int? LicenseId,
    [property: JsonPropertyName("licenseName")]
    string? LicenseName,
    ...
    [property: JsonPropertyName("notesUpdatedByUserName")]
    string? NotesUpdatedByUserName,
    [property: JsonPropertyName("notesUpdatedUtc")]
    DateTimeOffset? NotesUpdatedUtc,
    ...
    TargetAssignmentVisibilityResource Visibility);
