...
[Cmdlet(VerbsCommon.New, "GlobalMediaResponse")]
public class NewGlobalMediaResponse : Cmdlet {
    ...
    protected override void ProcessRecord() {
        GlobalMediaResponse outputObject = new(BlobReference, Category, CreatedDateUtc, DatabaseType, FileName, Id, MimeType, Name, PackageHash, RelativeCacheSourcePath, UpdatedDateUtc);
