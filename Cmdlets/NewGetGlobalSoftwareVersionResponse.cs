...
[Cmdlet(VerbsCommon.New, "GetGlobalSoftwareVersionResponse")]
public class NewGetGlobalSoftwareVersionResponse : Cmdlet {
    ...
    [Parameter(Mandatory = true)] public required GetGlobalSoftwareResponse Software { get; set; }
