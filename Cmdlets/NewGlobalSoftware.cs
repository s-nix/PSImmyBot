...
[Cmdlet(VerbsCommon.New, "GlobalSoftware")]
public class NewGlobalSoftware : Cmdlet {
    ...
    [Parameter(Mandatory = false)] public ICollection<GlobalSoftwareVersion>? SoftwareVersions { get; set; }
