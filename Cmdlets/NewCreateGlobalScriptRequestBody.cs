...
[Cmdlet(VerbsCommon.New, "CreateGlobalScriptRequestBody")]
public class NewCreateGlobalScriptRequestBody : Cmdlet {
    ...
    protected override void ProcessRecord() {
        CreateGlobalScriptRequestBody outputObject = new(Action, Name, OutputType, ScriptCategory, ScriptExecutionContext, ScriptLanguage, ScriptType, Timeout);
