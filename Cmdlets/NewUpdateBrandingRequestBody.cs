...
[Cmdlet(VerbsCommon.New, "UpdateBrandingRequestBody")]
public class NewUpdateBrandingRequestBody : Cmdlet {
    ...
    protected override void ProcessRecord() {
        UpdateBrandingRequestBody outputObject = new(BackgroundColor, Description, EndDate, ForegroundColor, FromAddress, Id, IgnoreYear, LogoAltText, LogoUri, MascotImgUri, MascotName, StartDate, TableHeaderColor, TableHeaderTextColor, TenantId, TextColor, TimeFormat);
