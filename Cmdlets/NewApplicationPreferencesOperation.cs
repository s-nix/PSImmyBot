...
[Cmdlet(VerbsCommon.New, "ApplicationPreferencesOperation")]
public class NewApplicationPreferencesOperation : Cmdlet {
    ...
    protected override void ProcessRecord() {
        ApplicationPreferencesOperation outputObject = new(From, Op, OperationType, Path, Value);
