...
[Cmdlet(VerbsCommon.New, "TenantPreferencesOperation")]
public class NewTenantPreferencesOperation : Cmdlet {
    ...
    protected override void ProcessRecord() {
        TenantPreferencesOperation outputObject = new(From, Op, OperationType, Path, Value);
