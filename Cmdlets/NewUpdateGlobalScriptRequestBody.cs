...
[Cmdlet(VerbsCommon.New, "UpdateGlobalScriptRequestBody")]
public class NewUpdateGlobalScriptRequestBody : Cmdlet {
    ...
    protected override void ProcessRecord() {
        UpdateGlobalScriptRequestBody outputObject = new(Action, Name, OutputType, ScriptCategory, ScriptExecutionContext, ScriptLanguage, ScriptType, Timeout);
