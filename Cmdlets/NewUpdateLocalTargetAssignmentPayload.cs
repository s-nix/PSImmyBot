...
[Cmdlet(VerbsCommon.New, "UpdateLocalTargetAssignmentPayload")]
public class NewUpdateLocalTargetAssignmentPayload : Cmdlet {
    ...
    protected override void ProcessRecord() {
        UpdateLocalTargetAssignmentPayload outputObject = new(AllowAccessToParentTenant, DesiredSoftwareState, Excluded, Id, LicenseId, MaintenanceIdentifier, MaintenanceTaskMode, MaintenanceType, OnboardingOnly, PropagateToChildTenants, ProviderClientGroupType, ProviderDeviceGroupType, ProviderLinkId, ProviderLinkIdForMaintenanceItem, SoftwareProviderType, SoftwareSemanticVersion, Target, TargetCategory, TargetEnforcement, TargetGroupFilter, TargetType, TaskParameterValues, TenantId, Visibility);
