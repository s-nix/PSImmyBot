...
[Cmdlet(VerbsCommon.New, "AnalyzeGlobalSoftwarePackageResponse")]
public class NewAnalyzeGlobalSoftwarePackageResponse : Cmdlet {
    ...
    protected override void ProcessRecord() {
        AnalyzeGlobalSoftwarePackageResponse outputObject = new(BatchInstallScript, DefaultPowershellUninstallScript, Description, DetectionScript, DisplayVersion, Extension, FileName, IsExe, IsMsi, PackageHash, PackageType, PowerShellInstallScript, PowerShellUninstallScript, ProductCode, SoftwareTableName, UpgradeCode);
