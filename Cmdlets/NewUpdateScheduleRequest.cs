...
[Cmdlet(VerbsCommon.New, "UpdateScheduleRequest")]
public class NewUpdateScheduleRequest : Cmdlet {
    ...
    protected override void ProcessRecord() {
        UpdateScheduleRequest outputObject = new(AllowAccessToMspResources, AllowAccessToParentTenant, ApplyWindowsUpdates, AutoConsentToReboots, CustomCronExpression, Day, Disabled, Id, MaintenanceIdentifier, MaintenanceTime, MaintenanceType, Name, OfflineBehavior, PromptTimeoutAction, PromptTimeoutMinutes, PropagateToChildTenants, ProviderClientGroupType, ProviderDeviceGroupType, ProviderLinkId, RebootPreference, ScheduleExecutionAfterActiveHours, SendDetectionEmail, SendDetectionEmailWhenAllActionsAreCompliant, SendFollowUpEmail, SendFollowUpOnlyIfActionNeeded, ShowMaintenanceActions, ShowPostponeButton, ShowRunNowButton, SuppressRebootsDuringBusinessHours, Target, TargetCategory, TargetGroupFilter, TargetType, TenantId, Time, TimeZoneInfoId, UseComputersTimezoneForExecution);
