...
[Cmdlet(VerbsCommon.New, "Oauth2AccessTokenWithTenantNameResponse")]
public class NewOauth2AccessTokenWithTenantNameResponse : Cmdlet {
    ...
    [Parameter(Mandatory = true)] public required bool IsUsingDefaultClientId { get; set; }
    ...
    protected override void ProcessRecord() {
        Oauth2AccessTokenWithTenantNameResponse outputObject = new(AccessTokenExpiresAtUtc, AccessTokenId, AllowSilentRefresh, ConsentData, CreatedBy, CreatedDate, Id, IdentityTokenId, IsUsingDefaultClientId, RefreshTokenExpiresAtUtc, RefreshTokenId, TenantName, TenantPrincipalId, TokenType, UpdatedBy, UpdatedDate);
