...
[Cmdlet(VerbsCommon.New, "LocalSoftwareVersion")]
public class NewLocalSoftwareVersion : Cmdlet {
    ...
    protected override void ProcessRecord() {
        LocalSoftwareVersion outputObject = new(Architecture, BlobName, CreatedBy, CreatedByUser, CreatedDate, DependsOnSemanticVersion, DeprecatedIdField, DisplayName, DisplayVersion, InstallerFile, InstallerType, InstallScript, InstallScriptId, InstallScriptType, LastResult, LicenseType, MaintenanceType, Notes, NumActionFailures, NumActionSuccesses, PackageHash, PackageType, PostInstallScript, PostInstallScriptId, PostInstallScriptType, PostUninstallScript, PostUninstallScriptId, PostUninstallScriptType, ProductCode, RelativeCacheSourcePath, SemanticVersion, SemanticVersionString, Software, SoftwareId, SoftwareIdentifier, SoftwareType, TestFailedError, TestRequired, TestScript, TestScriptId, TestScriptType, UninstallScript, UninstallScriptId, UninstallScriptType, UpdatedBy, UpdatedByUser, UpdatedDate, UpgradeScript, UpgradeScriptId, UpgradeScriptType, UpgradeStrategy, Url);
