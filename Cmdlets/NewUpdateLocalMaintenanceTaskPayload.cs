...
[Cmdlet(VerbsCommon.New, "UpdateLocalMaintenanceTaskPayload")]
public class NewUpdateLocalMaintenanceTaskPayload : Cmdlet {
    ...
    [Parameter(Mandatory = false)] public ICollection<MaintenanceTaskParameterPayload>? Parameters { get; set; }
    ...
    [Parameter(Mandatory = false)] public ICollection<LocalMaintenanceTaskTenantPayload>? Tenants { get; set; }
    ...
    protected override void ProcessRecord() {
        UpdateLocalMaintenanceTaskPayload outputObject = new(DatabaseType, ExecuteSerially, GetEnabled, GetScriptId, GetScriptType, IconMediaId, Id, IgnoreDuringAutomaticOnboarding, IntegrationTypeId, IsConfigurationTask, MaintenanceTaskCategory, Name, Notes, OnboardingOnly, Parameters, Recommended, SetEnabled, SetScriptId, SetScriptType, SupersededByTaskId, SupersededByTaskMigrationScriptId, SupersededByTaskMigrationScriptType, SupersededByTaskType, Tenants, TestEnabled, TestScriptId, TestScriptType, UseScriptParamBlock);
