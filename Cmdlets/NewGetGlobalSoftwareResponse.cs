...
[Cmdlet(VerbsCommon.New, "GetGlobalSoftwareResponse")]
public class NewGetGlobalSoftwareResponse : Cmdlet {
    ...
    [Parameter(Mandatory = true)] public required GlobalMediaResponse SoftwareIcon { get; set; }
    ...
    [Parameter(Mandatory = false)] public ICollection<GetGlobalSoftwareVersionResponse>? SoftwareVersions { get; set; }
