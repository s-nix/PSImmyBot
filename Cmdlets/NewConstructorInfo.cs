...
[Cmdlet(VerbsCommon.New, "ConstructorInfo")]
public class NewConstructorInfo : Cmdlet {
    ...
    protected override void ProcessRecord() {
        ConstructorInfo outputObject = new(Attributes, CallingConvention, ContainsGenericParameters, CustomAttributes, DeclaringType, IsAbstract, IsAssembly, IsCollectible, IsConstructedGenericMethod, IsConstructor, IsFamily, IsFamilyAndAssembly, IsFamilyOrAssembly, IsFinal, IsGenericMethod, IsGenericMethodDefinition, IsHideBySig, IsPrivate, IsPublic, IsSecurityCritical, IsSecuritySafeCritical, IsSecurityTransparent, IsSpecialName, IsStatic, IsVirtual, MemberType, MetadataToken, MethodHandle, MethodImplementationFlags, Module, Name, ReflectedType);
